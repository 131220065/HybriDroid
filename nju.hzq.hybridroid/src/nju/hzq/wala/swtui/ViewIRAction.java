...
public class ViewIRAction extends Action {
  ...
  private Collection<Statement> slice = null;
  ...
  public ViewIRAction(SWTTreeViewer v, CallGraph cg, String psFile, String dotFile, String dotExe, String gvExe,
		Collection<Statement> slice) {
	  this(v, cg, psFile, dotFile, dotExe, gvExe);
	  this.slice = slice;
  }
...
/**
  ...
  public void run() {
    ...
    try {
      PDFViewUtil.ghostviewIR(cg.getClassHierarchy(), ir, psFile, dotFile, dotExe, gvExe, null);
    } catch (WalaException e) {
      e.printStackTrace();
    }
    System.out.println("hzq: ir = " + ir.getClass());
    System.out.println("\n\nhzq: the sliced instruction of method " + ir.getMethod() + "is below:");
    List<Statement> sList = SliceTools.getSlicedNodesOf(ir, slice);
    SliceTools.printInstructionAndLineOfJavaByteCode(sList);
  }
