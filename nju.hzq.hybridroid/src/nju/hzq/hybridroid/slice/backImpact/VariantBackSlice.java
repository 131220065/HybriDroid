...
public class VariantBackSlice {
	private CallGraph cg = null;
	private PointerAnalysis<InstanceKey> pa = null;
	private SDG<InstanceKey> sdg = null;
	
	public VariantBackSlice(CallGraph cg, PointerAnalysis<InstanceKey> pa, DataDependenceOptions ddo, ControlDependenceOptions cdo) {
		if(cg == null || pa == null) {
	...
	public Collection<Statement> mainOnce() {
		...
		try {
			...
			Collection<Statement> slice = Slicer.computeBackwardSlice(sdg, s);
